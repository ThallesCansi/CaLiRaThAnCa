...
gdjs.JogoCode.GDShadedLightJoystickObjects1_1final = [];
...
gdjs.JogoCode.GDShadedLightJoystickObjects1= [];
gdjs.JogoCode.GDShadedLightJoystickObjects2= [];
gdjs.JogoCode.GDShadedLightJoystickObjects3= [];
gdjs.JogoCode.GDShadedLightJoystickObjects4= [];
gdjs.JogoCode.GDFlatLightJoystickObjects1= [];
gdjs.JogoCode.GDFlatLightJoystickObjects2= [];
gdjs.JogoCode.GDFlatLightJoystickObjects3= [];
gdjs.JogoCode.GDFlatLightJoystickObjects4= [];
...
gdjs.JogoCode.GDShadedLightJoystickObjects1.length = 0;


let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{gdjs.JogoCode.GDShadedLightJoystickObjects1_1final.length = 0;
...
{
gdjs.copyArray(runtimeScene.getObjects("ShadedLightJoystick"), gdjs.JogoCode.GDShadedLightJoystickObjects2);
for (var i = 0, k = 0, l = gdjs.JogoCode.GDShadedLightJoystickObjects2.length;i<l;++i) {
    if ( gdjs.JogoCode.GDShadedLightJoystickObjects2[i].IsPressed(null) ) {
        isConditionTrue_1 = true;
        gdjs.JogoCode.GDShadedLightJoystickObjects2[k] = gdjs.JogoCode.GDShadedLightJoystickObjects2[i];
        ++k;
    }
}
gdjs.JogoCode.GDShadedLightJoystickObjects2.length = k;
if(isConditionTrue_1) {
    isConditionTrue_0 = true;
    for (let j = 0, jLen = gdjs.JogoCode.GDShadedLightJoystickObjects2.length; j < jLen ; ++j) {
        if ( gdjs.JogoCode.GDShadedLightJoystickObjects1_1final.indexOf(gdjs.JogoCode.GDShadedLightJoystickObjects2[j]) === -1 )
            gdjs.JogoCode.GDShadedLightJoystickObjects1_1final.push(gdjs.JogoCode.GDShadedLightJoystickObjects2[j]);
    }
}
}
{
gdjs.copyArray(gdjs.JogoCode.GDShadedLightJoystickObjects1_1final, gdjs.JogoCode.GDShadedLightJoystickObjects1);
}
}
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(19661260);
}
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(19663892);
}
if (isConditionTrue_0) {
...
gdjs.JogoCode.mapOfGDgdjs_9546JogoCode_9546GDEarth_95959595orbitObjects2Objects = Hashtable.newFrom({"Earth_orbit": gdjs.JogoCode.GDEarth_9595orbitObjects2});
gdjs.JogoCode.mapOfGDgdjs_9546JogoCode_9546GDEarth_95959595orbitObjects2Objects = Hashtable.newFrom({"Earth_orbit": gdjs.JogoCode.GDEarth_9595orbitObjects2});
...
gdjs.copyArray(runtimeScene.getObjects("Earth_orbit"), gdjs.JogoCode.GDEarth_9595orbitObjects2);
/* Reuse gdjs.JogoCode.GDShipObjects2 */

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.JogoCode.mapOfGDgdjs_9546JogoCode_9546GDShipObjects2Objects, gdjs.JogoCode.mapOfGDgdjs_9546JogoCode_9546GDEarth_95959595orbitObjects2Objects, false, runtimeScene, false);
if (isConditionTrue_0) {
/* Reuse gdjs.JogoCode.GDEarth_9595orbitObjects2 */
/* Reuse gdjs.JogoCode.GDShipObjects2 */
{for(var i = 0, len = gdjs.JogoCode.GDShipObjects2.length ;i < len;++i) {
    gdjs.JogoCode.GDShipObjects2[i].separateFromObjectsList(gdjs.JogoCode.mapOfGDgdjs_9546JogoCode_9546GDEarth_95959595orbitObjects2Objects, false);
}
}
}
...
{ //Subevents
gdjs.JogoCode.eventsList5(runtimeScene);} //End of subevents
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(19668588);
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.runtimeScene.getTimerElapsedTimeInSecondsOrNaN(runtimeScene, "score_temp") >= 5;
if (isConditionTrue_0) {
...
gdjs.JogoCode.asyncCallback19661860 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.1), (runtimeScene) => (gdjs.JogoCode.asyncCallback19661860(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.JogoCode.userFunc0xbc3fa0 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
gdjs.JogoCode.userFunc0xbc3fa0(runtimeScene);
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(19660724);
}
if (isConditionTrue_0) {
...
{ //Subevents
gdjs.JogoCode.eventsList12(runtimeScene);} //End of subevents
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(19674812);
}
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(19677212);
}
if (isConditionTrue_0) {
...
{runtimeScene.getGame().getVariables().getFromIndex(1).setString("Venceu");
}
}
...
gdjs.JogoCode.eventsList15(runtimeScene);
}
...
gdjs.JogoCode.GDShadedLightJoystickObjects1.length = 0;
gdjs.JogoCode.GDShadedLightJoystickObjects2.length = 0;
gdjs.JogoCode.GDShadedLightJoystickObjects3.length = 0;
gdjs.JogoCode.GDShadedLightJoystickObjects4.length = 0;
gdjs.JogoCode.GDFlatLightJoystickObjects1.length = 0;
gdjs.JogoCode.GDFlatLightJoystickObjects2.length = 0;
gdjs.JogoCode.GDFlatLightJoystickObjects3.length = 0;
gdjs.JogoCode.GDFlatLightJoystickObjects4.length = 0;
