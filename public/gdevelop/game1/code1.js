...
gdjs.GameCode.GDLeaderboardDialogObjects5= [];
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11570652);
}
}
if (isConditionTrue_0) {
...
{gdjs.evtTools.object.createObjectOnScene(runtimeScene, gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDTopPillarObjects3Objects, 450, gdjs.randomInRange(110, 320), "");
}
{gdjs.evtTools.object.createObjectOnScene(runtimeScene, gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDBottomPillar2Objects3Objects, 450, (( gdjs.GameCode.GDTopPillarObjects3.length === 0 ) ? 0 :gdjs.GameCode.GDTopPillarObjects3[0].getPointY("")) + 120, "");
}
...
};gdjs.GameCode.asyncCallback11585524 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.GameCode.asyncCallback11585524(runtimeScene, asyncObjectsList)));
}
}
...
for (var i = 0, k = 0, l = gdjs.GameCode.GDTopPillarObjects2.length;i<l;++i) {
    if ( gdjs.GameCode.GDTopPillarObjects2[i].getX() < (( gdjs.GameCode.GDRocketObjects2.length === 0 ) ? 0 :gdjs.GameCode.GDRocketObjects2[0].getPointX("Centre")) ) {
        isConditionTrue_0 = true;
...
for (var i = 0, k = 0, l = gdjs.GameCode.GDBottomPillar2Objects2.length;i<l;++i) {
    if ( gdjs.GameCode.GDBottomPillar2Objects2[i].getX() < (( gdjs.GameCode.GDRocketObjects2.length === 0 ) ? 0 :gdjs.GameCode.GDRocketObjects2[0].getPointX("Centre")) ) {
        isConditionTrue_0 = true;
...
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.GameCode.GDTopPillarObjects2.length;i<l;++i) {
    if ( gdjs.GameCode.GDTopPillarObjects2[i].getX() > (( gdjs.GameCode.GDRocketObjects2.length === 0 ) ? 0 :gdjs.GameCode.GDRocketObjects2[0].getPointX("Centre")) - 60 ) {
        isConditionTrue_0 = true;
        gdjs.GameCode.GDTopPillarObjects2[k] = gdjs.GameCode.GDTopPillarObjects2[i];
        ++k;
    }
...
gdjs.GameCode.GDTopPillarObjects2.length = k;
for (var i = 0, k = 0, l = gdjs.GameCode.GDBottomPillar2Objects2.length;i<l;++i) {
    if ( gdjs.GameCode.GDBottomPillar2Objects2[i].getX() > (( gdjs.GameCode.GDRocketObjects2.length === 0 ) ? 0 :gdjs.GameCode.GDRocketObjects2[0].getPointX("Centre")) - 60 ) {
        isConditionTrue_0 = true;
        gdjs.GameCode.GDBottomPillar2Objects2[k] = gdjs.GameCode.GDBottomPillar2Objects2[i];
        ++k;
    }
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11575156);
}
if (isConditionTrue_0) {
{gdjs.evtTools.runtimeScene.resetTimer(runtimeScene, "pipe_spawn");
}
...
};gdjs.GameCode.asyncCallback11589316 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.GameCode.localVariables);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.1), (runtimeScene) => (gdjs.GameCode.asyncCallback11589316(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.GameCode.userFunc0x953b00 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
console.log('CAIO É MUIIITO FERA')
};
...
gdjs.GameCode.userFunc0x953b00(runtimeScene);
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11588748);
}
if (isConditionTrue_0) {
...
gdjs.copyArray(runtimeScene.getObjects("RESTAR"), gdjs.GameCode.GDRESTARObjects2);

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.GameCode.GDRESTARObjects2.length;i<l;++i) {
    if ( gdjs.GameCode.GDRESTARObjects2[i].IsClicked(null) ) {
        isConditionTrue_0 = true;
        gdjs.GameCode.GDRESTARObjects2[k] = gdjs.GameCode.GDRESTARObjects2[i];
        ++k;
    }
}
gdjs.GameCode.GDRESTARObjects2.length = k;
if (isConditionTrue_0) {
...
gdjs.GameCode.GDLeaderboardDialogObjects5.length = 0;
