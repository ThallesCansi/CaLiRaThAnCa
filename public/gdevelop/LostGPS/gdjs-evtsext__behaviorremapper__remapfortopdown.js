...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = eventsFunctionContext.getOnceTriggers().triggerOnce(18196228);
}
if (isConditionTrue_0) {
...
{for(var i = 0, len = gdjs.evtsExt__BehaviorRemapper__RemapForTopdown.RemapForTopdown.prototype.SetCustomContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__BehaviorRemapper__RemapForTopdown.RemapForTopdown.prototype.SetCustomContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setUp("" + eventsFunctionContext.getArgument("up"));
}
}
{for(var i = 0, len = gdjs.evtsExt__BehaviorRemapper__RemapForTopdown.RemapForTopdown.prototype.SetCustomContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__BehaviorRemapper__RemapForTopdown.RemapForTopdown.prototype.SetCustomContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setLeft("" + eventsFunctionContext.getArgument("left"));
}
}
{for(var i = 0, len = gdjs.evtsExt__BehaviorRemapper__RemapForTopdown.RemapForTopdown.prototype.SetCustomContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__BehaviorRemapper__RemapForTopdown.RemapForTopdown.prototype.SetCustomContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setRight("" + eventsFunctionContext.getArgument("right"));
}
}
{for(var i = 0, len = gdjs.evtsExt__BehaviorRemapper__RemapForTopdown.RemapForTopdown.prototype.SetCustomContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__BehaviorRemapper__RemapForTopdown.RemapForTopdown.prototype.SetCustomContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setDown("" + eventsFunctionContext.getArgument("down"));
}
}
}
