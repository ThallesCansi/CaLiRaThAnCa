...
gdjs.evtsExt__YSort__YSort.YSort = class YSort extends gdjs.RuntimeBehavior {
  constructor(instanceContainer, behaviorData, owner) {
    ...
    this._behaviorData.Offset = behaviorData.Offset !== undefined ? behaviorData.Offset : Number("0") || 0;
  }

  // Hot-reload:
  updateFromBehaviorData(oldBehaviorData, newBehaviorData) {
    
    if (oldBehaviorData.Offset !== newBehaviorData.Offset)
      this._behaviorData.Offset = newBehaviorData.Offset;
  ...
  getNetworkSyncData() {
    ...
    Offset: this._behaviorData.Offset,
      }
    };
  }
  updateFromNetworkSyncData(networkSyncData) {
    ...
    if (networkSyncData.props.Offset !== undefined)
      this._behaviorData.Offset = networkSyncData.props.Offset;
  }
